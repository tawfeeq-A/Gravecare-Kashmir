-- Secure Supabase setup for gravecare-Kashmir landing page
...
as $$
  select $json$
{
  "seoTitle": "gravecare-Kashmir | Grave Maintenance in Srinagar",
  ...
  "floatThreeTitle": "🧱 Repairs / Custom",
  "floatThreeText": "Discuss repairs, leveling and special work.",
  ...
  "galleryPlaceholder3": "Add an Instagram or Facebook reel showing alignment or repair work.",
...
create table if not exists public.site_settings (
  id text primary key default 'main',
  brand_name text default 'gravecare-Kashmir',
  whatsapp_number text default '',
  instagram_profile_url text default 'https://www.instagram.com/',
  facebook_profile_url text default 'https://www.facebook.com/',
  ...
  whatsapp_message text default 'Hello, I need gravecare-Kashmir service. I would like to discuss deweeding, bush removal, grave alignment, repairs or custom work.',
...
alter table public.site_settings add column if not exists facebook_profile_url text default 'https://www.facebook.com/';
...
values (
  ...
  'Hello, I need gravecare-Kashmir service. I would like to discuss deweeding, bush removal, grave alignment, repairs or custom work.',
...
set
  ...
  facebook_profile_url = coalesce(facebook_profile_url, 'https://www.facebook.com/'),
